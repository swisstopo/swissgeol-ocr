...
def test_parse_response():
    response = {
        ...
        'Blocks': [
            {'BlockType': 'PAGE', 'Geometry': {'BoundingBox': {'Width': 0.778192400932312, 'Height': 0.5504970550537109, 'Left': 0.10665097087621689, 'Top': 0.10083939880132675}, 'Polygon': [{'X': 0.10679113864898682, 'Y': 0.10083939880132675}, {'X': 0.8848433494567871, 'Y': 0.10111355036497116}, {'X': 0.8846840262413025, 'Y': 0.6513364315032959}, {'X': 0.10665097087621689, 'Y': 0.6509254574775696}]}, 'Id': 'a81edf66-b058-4317-adab-5bf4725f41d8', 'Relationships': [{'Type': 'CHILD', 'Ids': ['add5e2cc-a953-4d24-aca0-1ad68086ec38', 'b4044f2d-7f2d-45d0-832c-37897fb3776c', '738d4f72-5ca8-4a96-ad54-d609c0152782', 'a6b6d29c-3b66-41da-8fce-143e3a0f1749', '322fda1a-88a0-45c0-95ed-c5a2b78a50a3']}]},
            {'BlockType': 'LINE', 'Confidence': 90.83386993408203, 'Text': 'Merry', 'Geometry': {'BoundingBox': {'Width': 0.29303497076034546, 'Height': 0.09029601514339447, 'Left': 0.34796637296676636, 'Top': 0.22256392240524292}, 'Polygon': [{'X': 0.34799033403396606, 'Y': 0.22256392240524292}, {'X': 0.6410013437271118, 'Y': 0.2226785570383072}, {'X': 0.6409761905670166, 'Y': 0.3128599226474762}, {'X': 0.34796637296676636, 'Y': 0.312736839056015}]}, 'Id': 'add5e2cc-a953-4d24-aca0-1ad68086ec38', 'Relationships': [{'Type': 'CHILD', 'Ids': ['15a29d31-5734-4a8f-beb4-0f7c781f608b']}]},
            {'BlockType': 'LINE', 'Confidence': 99.56712341308594, 'Text': 'Christmas', 'Geometry': {'BoundingBox': {'Width': 0.4656425416469574, 'Height': 0.08312307298183441, 'Left': 0.2757081985473633, 'Top': 0.30257537961006165}, 'Polygon': [{'X': 0.2757299542427063, 'Y': 0.30257537961006165}, {'X': 0.7413507699966431, 'Y': 0.3027694523334503}, {'X': 0.7413272857666016, 'Y': 0.38569843769073486}, {'X': 0.2757081985473633, 'Y': 0.3854920268058777}]}, 'Id': 'b4044f2d-7f2d-45d0-832c-37897fb3776c', 'Relationships': [{'Type': 'CHILD', 'Ids': ['4ce5482a-af20-4e0b-9ca7-3b5fece0dc62']}]},
            {'BlockType': 'LINE', 'Confidence': 100.0, 'Text': 'AND', 'Geometry': {'BoundingBox': {'Width': 0.08761616796255112, 'Height': 0.020372536033391953, 'Left': 0.4544379413127899, 'Top': 0.38989371061325073}, 'Polygon': [{'X': 0.45444342494010925, 'Y': 0.38989371061325073}, {'X': 0.5420541167259216, 'Y': 0.38993266224861145}, {'X': 0.5420485138893127, 'Y': 0.410266250371933}, {'X': 0.4544379413127899, 'Y': 0.4102267026901245}]}, 'Id': '738d4f72-5ca8-4a96-ad54-d609c0152782', 'Relationships': [{'Type': 'CHILD', 'Ids': ['0f802ead-cc95-4cf2-b8cf-f11ff83a9811']}]},
    ...
    response = {
        'Blocks': [
            {'BlockType': 'OTHER', 'Geometry': {'BoundingBox': {'Width': 0.1646667718887329, 'Height': 0.0383591502904892, 'Left': 0.4189315438270569, 'Top': 0.4527221918106079}, 'Polygon': [{'X': 0.41894182562828064, 'Y': 0.4527221918106079}, {'X': 0.5835983157157898, 'Y': 0.4527987241744995}, {'X': 0.5835877060890198, 'Y': 0.4910813570022583}, {'X': 0.4189315438270569, 'Y': 0.49100279808044434}], 'RotationAngle': 0.0}, 'Id': '9b0e9dcc-d49d-4d13-9133-680856b0b7bf'}
        ],
    }
    assert text_lines_from_response(response, transform, page_height) == []
